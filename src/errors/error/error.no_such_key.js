 ...
 */
export default class NoSuchKeyError extends CustomError {
    /**
     ...
     *  @overload
     *  @param { string } message - The message of the error.
     *  @param { import('../../types/types.js').NoSuchKeyErrorOptions } [options] - An option meta data options to include for the error.
     */
...
// #: Global Entry
__setGlobal('NoSuchKeyError', NoSuchKeyError, { writable: false });
